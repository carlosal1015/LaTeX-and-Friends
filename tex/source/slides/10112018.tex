% arara: clean: {extensions: ['log','out','aux','snm','listing','nav','sagetex.sage','sagetex.sage.py','sagetex.scmd','sagetex.sout','toc','vrb']}
% arara: xelatex
% arara: sage
% arara: xelatex
% arara: clean: {extensions: ['log','out','aux','snm','listing','nav','sagetex.sage','sagetex.sage.py','sagetex.scmd','sagetex.sout','toc','vrb']}
...
\input{./sections/2_1_arara}
%\input{./sections/2_sage}
%\input{architechture}
