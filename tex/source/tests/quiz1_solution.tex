...
\makebox[\textwidth]{Nombres y apellidos:\enspace Dimension R.\hfill}
\
...
\begin{parts}%\renewcommand\label[1]{}
	\part Linux, es el kérnel o npucleo.
...
\begin{multicols}{2}
\begin{checkboxes}
	\CorrectChoice Linus Benedict Torvalds.\ \finland{} %C
...
\begin{checkboxes}
	...
	\CorrectChoice \mintinline{bash}{git init} %C
